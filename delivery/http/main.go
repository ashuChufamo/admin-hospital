...
func main() {
	...
	router.GET("/admin/pharmasists", managPhaHand.GetPharmasists)
	router.GET("/admin/pharmasist/?id", managPhaHand.GetSinglePharmasist)
	router.PUT("/admin/pharmasist/?id", managPhaHand.UpdatePharmasist)
	router.POST("/admin/pharmasist", managPhaHand.AddPharmasist)
	router.DELETE("/admin/pharmasist/?id", managPhaHand.DeletePharmasist)
